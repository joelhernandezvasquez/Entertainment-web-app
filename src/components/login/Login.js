...
const Login = () => {
  ...
  return (
    <section className='login_wrapper flex flex_column_center animate__animated animate__fadeIn' role="region">
       <header>
         <img src={Logo} alt="Red Icon of Movie" />
       </header>

       <main role="main">
         <div className='login_container' role="form" aria-labelledby='sign-in-form'>
           <h1 className='white_text fw_300 fs_800'>Login</h1>
           <button className='signInBtn flex flex_center' aria-describedby='sign in google'> <i className="fa fa-google google_icon" aria-hidden="true"></i> Sign In with Google</button>
